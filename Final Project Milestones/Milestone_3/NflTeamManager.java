...
public class NflTeamManager {
    ...
    private String getRandomName(){
        ...
        return name[randomizer.nextInt(2)];
    ...
    private String getRandomLastName(){
        ...
        return lastName[randomizer.nextInt(2)];
        //Randomly picks a name and returns it.
    }
    
    private String getRandomPosition(){
        String[] position = {"QB", "RB", "WR"};
        //Array that stores random positions to be picked from at random.
        
        return position[randomizer.nextInt(2)];
    ...
    private  String getRandomTeam(){
        ...
        return team[randomizer.nextInt(2)];
        //Randomly picks a position and returns it.
    }
    ...
    public void createPlayer() {
        ...
        NFLPlayer player = new NFLPlayer(150 + randomizer.nextInt(50)/*Randomizes a height for the player with the lowest value of 150*/,
